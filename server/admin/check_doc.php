...
<div class="container mt-3 mb-4">
    <ul class=" text-center text-dark list-inline">
        <li class=" lead list-inline-item">Name : <?php echo $user_acc->getUsername(); ?></li>
        <li class="lead list-inline-item">&emsp;&emsp;Type : <?php echo ucfirst(strtolower($user_acc->getAcType())); ?></li>
        <li class="lead list-inline-item">&emsp;&emsp;Email : <?php echo $user_acc->getEmailAddress(); ?></li>
    </ul>
        ...
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="process/doc_correct.php">
    ...
    <div class="modal fade" id="exampleModa2" tabindex="-1" aria-labelledby="exampleModalLabe2" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered ">
            ...
            <div class="modal-content">
                <form action="process/doc_wrong.php" method="get">
                    <div class="modal-header">
...
<script>
    $('title').text("Check Vertification Documents");
    $('#title1').text("Check Vertification Documents");
    $("#search1").hide();
</script>